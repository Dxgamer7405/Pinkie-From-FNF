...
class Song
{
	...
	public static function loadFromJson(jsonInput:String, ?folder:String):SwagSong
	{
		...
		if (!Util.exists(Paths.json(folder.toLowerCase() + '/' + jsonInput.toLowerCase()))){
			return null;
		}
		var rawJson = Util.getContent(Paths.json(folder.toLowerCase() + '/' + jsonInput.toLowerCase())).trim();
